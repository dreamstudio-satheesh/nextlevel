...
@section('script')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const hetznerConfig = @json($hetznerConfig); // Add Hetzner config
            ...
            // Hetzner Config Check
            const isHetznerConfigComplete = Object.values(hetznerConfig).every(value => value !== null && value !==
                '');
            const hetznerRadio = document.getElementById('hetznerRadio');
            const hetznerNote = document.getElementById('hetznerNote');
            if (!isHetznerConfigComplete) {
                hetznerRadio.disabled = true;
                $('#hetznerNote').removeClass('d-none');
            } else {
                $('#hetznerNote').addClass('d-none');
            }
        });
    </script>
@endsection
        ...
        <div class="col-lg-6 col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body px-4">
                    <form id="settingsForm" method="post" enctype="multipart/form-data" class="form-border"
                        autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{ $setting->app_name }}" type="text" name="app_name"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{ $setting->videoad_skip_time }}" type="text" name="videoad_skip_time"
                                        class="form-control" required>
                                </div>
                            </div>
                        </div>
                    ...
                    <form id="storageSettingForm" method="POST">
                        <div class="card w-auto p-3">
                            <div class="checkbox-slider d-flex align-items-center justify-content-between">
                                ...
                                <label>
                                    <input type="radio" class="d-none" name="storage_type" value="0" id="localRadio"
                                        {{ $setting->storage_type == 0 ? 'checked' : '' }}>
                        ...
                        <div class="card w-auto p-3">
                            <div class="checkbox-slider d-flex align-items-center justify-content-between">
                                <span class="me-3">
                                    {{ __('AWSS3') }}
                                    <br>
                                    <span id="awsNote" class="text-danger"> {{ __('pleaseAddValuesInEnvFile') }}
                                    </span>
                                </span>
                                <label>
                                    <input type="radio" class="d-none" name="storage_type" value="1"
                                        id="awsRadio" {{ $setting->storage_type == 1 ? 'checked' : '' }}>
                                    <span class="toggle_background">
                                        <div class="circle-icon"></div>
                                        <div class="vertical_line"></div>
                                    </span>
                            ...
                            <div class="checkbox-slider d-flex align-items-center justify-content-between">
                                ...
                                <label>
                                    <input type="radio" class="d-none" name="storage_type" value="2"
                                        id="doRadio" {{ $setting->storage_type == 2 ? 'checked' : '' }}>
                                    <span class="toggle_background">
                                        <div class="circle-icon"></div>
                                        <div class="vertical_line"></div>
                                    </span>
                                ...
                                <div class="col-xl-12 col-lg-6 mb-3">
                                    <div class="card w-auto p-3 m-0">
                                        <div class="checkbox-slider d-flex align-items-center justify-content-between">
                                            ...
                                            <label>
                                                <input type="checkbox" class="d-none is_admob_android"
                                                    {{ $setting->is_admob_android == 1 ? 'checked' : '' }}
                                                    name="is_admob_android">
                                                <span class="toggle_background">
                                                    <div class="circle-icon"></div>
                                                    <div class="vertical_line"></div>
                                                </span>
                                ...
                                <div class="col-xl-12 col-lg-6">
                                    <div class="card w-auto p-3 m-0">
                                        <div class="checkbox-slider d-flex align-items-center justify-content-between">
                                            ...
                                            <label>
                                                <input type="checkbox" class="d-none is_admob_ios"
                                                    {{ $setting->is_admob_ios == 1 ? 'checked' : '' }}
                                                    name="is_admob_ios">
                                                <span class="toggle_background">
                                                    <div class="circle-icon"></div>
                                                    <div class="vertical_line"></div>
                                ...
                                <div class="col-xl-12 col-lg-6 mb-3">
                                    <div class="card w-auto p-3 m-0">
                                        <div class="checkbox-slider d-flex align-items-center justify-content-between">
                                            ...
                                            <label>
                                                <input type="checkbox" class="d-none is_custom_android"
                                                    {{ $setting->is_custom_android == 1 ? 'checked' : '' }}
                                                    name="is_custom_android">
                                                <span class="toggle_background">
                                                    <div class="circle-icon"></div>
                                                    <div class="vertical_line"></div>
                                                </span>
                                ...
                                <div class="col-xl-12 col-lg-6">
                                    <div class="card w-auto p-3 m-0">
                                        <div class="checkbox-slider d-flex align-items-center justify-content-between">
                                            ...
                                            <label>
                                                <input type="checkbox" class="d-none is_custom_ios"
                                                    {{ $setting->is_custom_ios == 1 ? 'checked' : '' }}
                                                    name="is_custom_ios">
                                                <span class="toggle_background">
                                                    <div class="circle-icon"></div>
                                                    <div class="vertical_line"></div>
        ...
        <div class="col-md-3">
            <div class="card w-auto p-3">
                <div class="checkbox-slider d-flex align-items-center justify-content-between">
                    ...
                    <label>
                        <input type="checkbox" class="d-none enableDisableLiveTvTab"
                            {{ $setting->is_live_tv_enable == 1 ? 'checked' : '' }} name="is_live_tv_enable">
                        <span class="toggle_background">
                            <div class="circle-icon"></div>
                            <div class="vertical_line"></div>
                        </span>
